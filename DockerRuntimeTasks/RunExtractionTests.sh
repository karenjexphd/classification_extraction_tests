...
# NOTE: Currently no checks in place to confirm that the directories or files exist
...
# will generate basefilename_discovered_tables.json in $outputdir for each file

# ** WANT basefilename_pytheas_tables.json **
...
# OLD VERSION - TO DELETE ONCE NEW VERSION TESTED
